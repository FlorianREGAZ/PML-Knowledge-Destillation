...
@register_model
def ghostnetv3_small(**kwargs):
    """
    Constructs a GhostNet model optimized for CIFAR-10 (32x32 images)
    """
    cfgs = [
        # k, t, c, SE, s 
        # stage1 - Keep resolution at 32x32
        [[3,  16,  16, 0, 1]],
        # stage2 - First downsampling: 32x32 -> 16x16
        [[3,  32,  20, 0, 2]],
        [[3,  40,  20, 0, 1]],
        # stage3 - Keep at 16x16, no downsampling for better feature preservation
        [[3,  48,  32, 0.25, 1]],
        [[3,  64,  32, 0.25, 1]],
        # stage4 - Second downsampling: 16x16 -> 8x8
        [[3,  80,  48, 0, 2],
         [3,  96,  48, 0, 1],
         [3, 120,  64, 0.25, 1]
        ],
        # stage5 - Final feature extraction at 8x8
        [[3, 128,  80, 0.25, 1],
         [3, 160,  80, 0.25, 1]
        ]
    ]
...
if __name__=='__main__':
    model = ghostnetv3_small(width=1.0)
    model.eval()
    print(model)
