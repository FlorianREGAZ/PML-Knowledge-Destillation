...
def main():
    print("Starting Teacher assistant shortcut training.")
    torch.manual_seed(0)
    device = get_device()
    ...
    # checkpoint loading
    checkpoint_path = 'ta_shortcut_resnet18_ghostnetv3_cifar10_checkpoint.pth'
    start_epoch = 1
    best_acc = 0.0
    ...
    for epoch in range(start_epoch, EPOCHS + 1):
        ...
        if acc > best_acc:
            best_acc = acc
            torch.save(student.state_dict(), 'ta_shortcut_resnet_18_ghostnetv3_cifar10.pth')
